          ...
          {%- unless child.title == 'divider' -%}
            {
              ...
              {%- if child.permalink contains "/post/" -%}{%- assign url = "/post/" -%} {%- else -%}{%- assign url = child.permalink -%}{%- endif -%}
      ...
      {%- else -%}
        {
          ...
          {%- if p.permalink contains "/post/" -%}{%- assign url = "/post/" -%} {%- else -%}{%- assign url = p.url -%}{%- endif -%}
